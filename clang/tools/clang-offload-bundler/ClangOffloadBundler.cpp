...
static bool InputFileNamesSet = false;
static std::vector<std::string> InputFileNamesDeprecatedOpt;
static bool InputFileNamesDeprecatedOptSet = false;
static std::vector<std::string> OutputFileNames;
static bool OutputFileNamesSet = false;
static std::vector<std::string> OutputFileNamesDeprecatedOpt;
static bool OutputFileNamesDeprecatedOptSet = false;
static std::vector<std::string> TargetNames;
static bool TargetNamesSet = false;
static std::string FilesType;
static bool Unbundle = false;
static bool ListBundleIDs = false;
static bool PrintExternalCommands = false;
static bool AllowMissingBundles = false;
static unsigned BundleAlignment = 1;
static bool CheckInputArchive = false;
static bool HipOpenmpCompatible = false;
static bool Compress = false;
static bool CompressSet = false;
static bool Verbose = false;
static bool VerboseSet = false;
static int CompressionLevel = 0;
static bool CompressionLevelSet = false;
...
int main(int argc, const char **argv) {
  ...
  Help = Opts->get<&OBHelpOpt>();
  InputFileNames = Opts->get<&OBInputOpt>();
  InputFileNamesSet = Opts->specified<&OBInputOpt>();
  InputFileNamesDeprecatedOpt = Opts->get<&OBInputsOpt>();
  InputFileNamesDeprecatedOptSet = Opts->specified<&OBInputsOpt>();
  OutputFileNames = Opts->get<&OBOutputOpt>();
  OutputFileNamesSet = Opts->specified<&OBOutputOpt>();
  OutputFileNamesDeprecatedOpt = Opts->get<&OBOutputsOpt>();
  OutputFileNamesDeprecatedOptSet = Opts->specified<&OBOutputsOpt>();
  TargetNames = Opts->get<&OBTargetsOpt>();
  TargetNamesSet = Opts->specified<&OBTargetsOpt>();
  FilesType = Opts->get<&OBTypeOpt>();
  Unbundle = Opts->get<&OBUnbundleOpt>();
  ListBundleIDs = Opts->get<&OBListOpt>();
  PrintExternalCommands = Opts->get<&OBPrintExternalCommandsOpt>();
  AllowMissingBundles = Opts->get<&OBAllowMissingBundlesOpt>();
  BundleAlignment = Opts->get<&OBBundleAlignOpt>();
  CheckInputArchive = Opts->get<&OBCheckInputArchiveOpt>();
  HipOpenmpCompatible = Opts->get<&OBHipOpenmpCompatibleOpt>();
  Compress = Opts->get<&OBCompressOpt>();
  CompressSet = Opts->specified<&OBCompressOpt>();
  Verbose = Opts->get<&OBVerboseOpt>();
  VerboseSet = Opts->specified<&OBVerboseOpt>();
  CompressionLevel = Opts->get<&OBCompressionLevelOpt>();
  CompressionLevelSet = Opts->specified<&OBCompressionLevelOpt>();
