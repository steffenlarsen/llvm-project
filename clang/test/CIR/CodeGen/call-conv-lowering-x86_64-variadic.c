...
// CIR:         cir.copy %arg1 to %[[BLOCAL:[0-9]+]] : !cir.ptr<!rec_Big>
// CIR:         %[[PV:[0-9]+]] = cir.load %{{[0-9]+}} : !cir.ptr<!u64i>, !u64i
// CIR-NEXT:    %[[COPY:[0-9]+]] = cir.alloca "byval" align(8) : !cir.ptr<!rec_Big>
// CIR-NEXT:    cir.copy %[[BLOCAL]] align(8) to %[[COPY]] align(8) : !cir.ptr<!rec_Big>
...
// LLVM-CIR:       %[[BLOCAL:[0-9a-zA-Z._]+]] = alloca %struct.Big, align 8
// LLVM-CIR:       call void @llvm.memcpy.p0.p0.i64(ptr align 8 %[[BLOCAL]], ptr align 8 %[[B]], i64 32, i1 false)
// LLVM-CIR:       %[[PV:[0-9a-zA-Z._]+]] = load i64, ptr %{{[0-9a-zA-Z._]+}}, align 8
// LLVM-CIR-NEXT:  %[[COPY:[0-9a-zA-Z._]+]] = alloca %struct.Big, align 8
// LLVM-CIR-NEXT:  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %[[COPY]], ptr align 8 %[[BLOCAL]], i64 32, i1 false)
...
// LLVM-CIR:       call void @llvm.memcpy.p0.p0.i64(ptr align 8 %[[QLOCAL:[0-9a-zA-Z._]+]], ptr align 8 %[[Q]], i64 16, i1 false)
...
// LLVM-CIR-NEXT:  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %[[COPY]], ptr align 8 %[[QLOCAL]], i64 16, i1 false)
...
// CIR:         %[[PV:[0-9]+]] = cir.load %{{[0-9]+}} : !cir.ptr<!u64i>, !u64i
// CIR:         cir.copy %{{[0-9]+}} to %[[OUT:[0-9]+]] : !cir.ptr<!rec_Wide>
...
// LLVM-CIR:       %[[COPY:[0-9a-zA-Z._]+]] = alloca %struct.Wide, align 16
// LLVM-CIR:       store %struct.Wide %{{[0-9a-zA-Z._]+}}, ptr %[[OUT:[0-9a-zA-Z._]+]], align 16
// LLVM-CIR:       %[[PV:[0-9a-zA-Z._]+]] = load i64, ptr %{{[0-9a-zA-Z._]+}}, align 8
// LLVM-CIR-NEXT:  call void @llvm.memcpy.p0.p0.i64(ptr align 16 %[[COPY]], ptr align 16 %[[OUT]], i64 16, i1 false)
// LLVM-CIR-NEXT:  %[[WV:[0-9a-zA-Z._]+]] = load i128, ptr %[[COPY]], align 16
...
// CIR:         cir.copy %arg1 to %[[W:[0-9]+]] : !cir.ptr<!rec_WideChar>
// CIR:         %[[PV:[0-9]+]] = cir.load %{{[0-9]+}} : !cir.ptr<!u64i>, !u64i
...
// LLVM-CIR:       %[[WLOCAL:[0-9a-zA-Z._]+]] = alloca %struct.WideChar, align 16
// LLVM-CIR:       call void @llvm.memcpy.p0.p0.i64(ptr align 16 %[[WLOCAL]], ptr align 16 %[[W]], i64 32, i1 false)
// LLVM-CIR:       %[[PV:[0-9a-zA-Z._]+]] = load i64, ptr %{{[0-9a-zA-Z._]+}}, align 8
// LLVM-CIR-NEXT:  %[[COPY:[0-9a-zA-Z._]+]] = alloca %struct.WideChar, align 16
// LLVM-CIR-NEXT:  call void @llvm.memcpy.p0.p0.i64(ptr align 16 %[[COPY]], ptr align 16 %[[WLOCAL]], i64 32, i1 false)
...
// CIR-NEXT:    cir.copy %{{[0-9]+}} to %[[OUTCAST]] : !cir.ptr<!cir.int<s, 48, bitint>>
...
// LLVM-OGCG:       %[[RE:[0-9a-zA-Z._]+]] = load i64, ptr %[[BSLOT]], align 8
// LLVM-OGCG-NEXT:  %[[TR2:[0-9a-zA-Z._]+]] = trunc i64 %[[RE]] to i48
// LLVM-OGCG:       %[[PV:[0-9a-zA-Z._]+]] = load i64, ptr %{{[0-9a-zA-Z._]+}}, align
// LLVM-OGCG-NEXT:  %[[EXT2:[0-9a-zA-Z._]+]] = sext i48 %[[TR2]] to i64
// LLVM-OGCG-NEXT:  store i64 %[[EXT2]], ptr %[[CSLOT:[0-9a-zA-Z._]+]], align 8
// LLVM-OGCG-NEXT:  %[[ARG:[0-9a-zA-Z._]+]] = load i64, ptr %[[CSLOT]], align 8
// LLVM-OGCG:       call i32 (i64, ...) @vf(i64 %[[PV]], i64 noundef %[[ARG]])
// LLVM-CIR:        %[[PV:[0-9a-zA-Z._]+]] = load i64, ptr %{{[0-9a-zA-Z._]+}}, align
// LLVM-CIR-NEXT:   call void @llvm.memcpy.p0.p0.i64(ptr align 8 %[[COPY:[0-9a-zA-Z._]+]], ptr align 8 %[[BSLOT]], i64 8, i1 false)
// LLVM-CIR-NEXT:   %[[ARG:[0-9a-zA-Z._]+]] = load i64, ptr %[[COPY]], align 8
// LLVM-CIR:        call i32 (i64, ...) @vf(i64 %[[PV]], i64 noundef %[[ARG]])
