...
// CIR:   cir.libc.memcpy %[[SIZE]] bytes from %[[B_VOID_PTR_2]] to %[[B_VOID_PTR]] : !u64i, !cir.ptr<!void> -> !cir.ptr<!void>
...
// LLVM:   call void @llvm.memcpy.p0.p0.i64(ptr %[[B1]], ptr %[[B2]], i64 64, i1 false)
