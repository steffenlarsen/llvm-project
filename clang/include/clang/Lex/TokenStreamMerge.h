...
/// force_cuda_host_device, pack, attribute -- see ParseAST.cpp's classifier).
inline constexpr unsigned NumPragmaScopeKinds = 3;
...
using PragmaScopeClassifier = llvm::function_ref<PragmaScopeEvent(const Token &)>;
