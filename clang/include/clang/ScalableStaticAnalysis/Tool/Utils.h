...
/// with the OptionParser before parsing. Returns the resulting OptionsContext
/// so the caller can read back registries it added in ConfigureParser.
std::unique_ptr<llvm::clv2::OptionsContext>
initTool(int argc, const char **argv, llvm::StringRef Version,
         llvm::cl::OptionCategory &Category, llvm::StringRef ToolHeading,
