...
public:
  ...
  cir::CopyOp createCopy(mlir::Value dst, mlir::Value src,
    ...
    if (src.getType() != dst.getType()) {
      ...
      auto dstPtrTy = mlir::cast<cir::PointerType>(dst.getType());
      assert(srcPtrTy.getPointee() == dstPtrTy.getPointee() &&
             "createCopy: pointee types must match; only address space may "
             "differ");
      (void)dstPtrTy;
