...
//===----------------------------------------------------------------------===//
//
// Checks what TargetDivergence reports for representative target pairs.
// Divergence between real targets is expected to be rare; these tests
// document which primitive types actually differ.
//
//===----------------------------------------------------------------------===//
