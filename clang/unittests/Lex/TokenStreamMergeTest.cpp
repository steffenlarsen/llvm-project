...
// polarity of annot_pragma_pack's own Sema::PragmaMsStackAction-derived
// encoding. Confirms the 4th independently-tracked pragma-scope kind (added
// alongside GCC visibility -- see ParseAST.cpp's real classifier) is handled
// exactly like the other three, and that NumPragmaScopeKinds' fixed-size
// PragmaDepth array does not misbehave at its highest valid index.
