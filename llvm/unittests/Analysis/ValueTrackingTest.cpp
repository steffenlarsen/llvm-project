...
TEST_F(ValueTrackingTest, ComputeNumSignBits_Shuffle_Pointers) {
  parseAssembly("define <2 x ptr> @test(<2 x ptr> %x) {\n"
                "  %A = shufflevector <2 x ptr> zeroinitializer, <2 x ptr> "
...
TEST_F(ComputeKnownFPClassTest, SelectPosInf) {
  parseAssembly("define float @test(i1 %cond) {\n"
                "  %A = select i1 %cond, float 0x7FF0000000000000, float "
                "0x7FF0000000000000"
                "  ret float %A\n"
                "}\n");
...
TEST_F(ComputeKnownFPClassTest, SelectNegInf) {
  parseAssembly("define float @test(i1 %cond) {\n"
                "  %A = select i1 %cond, float 0xFFF0000000000000, float "
                "0xFFF0000000000000"
                "  ret float %A\n"
                "}\n");
...
TEST_F(ComputeKnownFPClassTest, SelectNNaN) {
  parseAssembly("define float @test(i1 %cond, float %arg0, float %arg1) {\n"
...
TEST_F(ComputeKnownFPClassTest, SelectNoFPClassArgUnionAll) {
  parseAssembly(
      "define float @test(i1 %cond, float nofpclass(snan ninf nsub pzero "
      "pnorm) %arg0, float nofpclass(qnan nnorm nzero psub pinf) %arg1) {\n"
...
TEST_F(ComputeKnownFPClassTest, SelectNoFPClassArgNoNan) {
  parseAssembly("define float @test(i1 %cond, float nofpclass(nan) %arg0, "
                "float nofpclass(nan) %arg1) {\n"
                "  %A = select i1 %cond, float %arg0, float %arg1"
                "  ret float %A\n"
                "}\n");
  expectKnownFPClass(~fcNan, std::nullopt);
...
TEST_F(ComputeKnownFPClassTest, SelectNoFPClassArgNoPInf) {
  parseAssembly("define float @test(i1 %cond, float nofpclass(inf) %arg0, "
                "float nofpclass(pinf) %arg1) {\n"
                "  %A = select i1 %cond, float %arg0, float %arg1"
                "  ret float %A\n"
                "}\n");
...
TEST_F(ComputeKnownFPClassTest, SelectNoFPClassArgNoNInf) {
  parseAssembly("define float @test(i1 %cond, float nofpclass(ninf) %arg0, "
                "float nofpclass(inf) %arg1) {\n"
                "  %A = select i1 %cond, float %arg0, float %arg1"
                "  ret float %A\n"
                "}\n");
...
TEST_F(ComputeKnownFPClassTest, SelectNoFPClassDeclarationNoNan) {
  parseAssembly("declare nofpclass(nan) float @no_nans()\n"
                "define float @test() {\n"
...
TEST_F(ComputeKnownFPClassTest, UIToFP) {
  parseAssembly("define float @test(i32 %arg0, i16 %arg1) {\n"
...
TEST_F(ComputeKnownFPClassTest, SIToFP) {
  parseAssembly("define float @test(i32 %arg0, i16 %arg1, i17 %arg2) {\n"
...
TEST_F(ComputeKnownFPClassTest, FAdd) {
  parseAssembly("define float @test(float nofpclass(nan inf) %nnan.ninf, float "
                "nofpclass(nan) %nnan, float nofpclass(qnan) %no.qnan, float "
                "%unknown) {\n"
...
TEST_F(ComputeKnownFPClassTest, FMul) {
  parseAssembly("define float @test(float noundef nofpclass(nan inf) "
                "%nnan.ninf0, float noundef nofpclass(nan inf) %nnan.ninf1, "
                "float noundef nofpclass(nan) %nnan, float noundef "
                "nofpclass(qnan) %no.qnan, float noundef %unknown) {\n"
...
TEST_F(ComputeKnownFPClassTest, FMulNoZero) {
  parseAssembly(
      "define float @test(float noundef nofpclass(zero) %no.zero, float "
      "noundef nofpclass(zero nan) %no.zero.nan0, float noundef nofpclass(zero "
      "nan) %no.zero.nan1, float noundef nofpclass(nzero nan) %no.negzero.nan, "
      "float noundef nofpclass(pzero nan) %no.poszero.nan, float noundef "
      "nofpclass(inf nan) %no.inf.nan, float noundef nofpclass(inf) %no.inf, "
      "float noundef nofpclass(nan) %no.nan) {\n"
...
TEST_F(ComputeKnownFPClassTest, Phi) {
  parseAssembly("define float @test(i1 %cond, float nofpclass(nan inf) %arg0, "
                "float nofpclass(nan) %arg1) {\n"
                "entry:\n"
...
TEST_F(ComputeKnownFPClassTest, PhiKnownSignFalse) {
  parseAssembly("declare float @llvm.fabs.f32(float)"
                "define float @test(i1 %cond, float nofpclass(nan) %arg0, "
                "float nofpclass(nan) %arg1) {\n"
                "entry:\n"
                "  br i1 %cond, label %bb0, label %bb1\n"
                "bb0:\n"
...
TEST_F(ComputeKnownFPClassTest, SelfPhiFirstArg) {
  parseAssembly("define float @test(i1 %cond, float nofpclass(inf) %arg) {\n"
                "entry:\n"
...
TEST_F(ComputeKnownBitsTest, KnownNonZeroShift) {
  ...
  parseAssembly("define i8 @test(i8 %p, ptr %pq) {\n"
