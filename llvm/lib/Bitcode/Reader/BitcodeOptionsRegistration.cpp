//===- BitcodeOptionsRegistration.cpp - clv2 option registration ----------===//
//
...
// registration.  See BitcodeOptionsRegistration.h.
//
//===----------------------------------------------------------------------===//
...
void llvm::registerBitcodeOptsOptions(llvm::clv2::OptionParser &P) {
