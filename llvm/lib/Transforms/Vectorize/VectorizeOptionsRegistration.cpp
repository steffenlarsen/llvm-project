//===- VectorizeOptionsRegistration.cpp - clv2 option registration
//----------===//
//
...
// registration.  See VectorizeOptionsRegistration.h.
//
//===----------------------------------------------------------------------===//
...
void llvm::registerVectorizeOptsOptions(llvm::clv2::OptionParser &P) {
