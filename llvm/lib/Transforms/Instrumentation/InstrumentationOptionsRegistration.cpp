//===- InstrumentationOptionsRegistration.cpp - clv2 option registration
//----------===//
//
...
// registration.  See InstrumentationOptionsRegistration.h.
//
//===----------------------------------------------------------------------===//
...
void llvm::registerInstrumentationOptsOptions(llvm::clv2::OptionParser &P) {
