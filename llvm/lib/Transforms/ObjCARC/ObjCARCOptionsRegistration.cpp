//===- ObjCARCOptionsRegistration.cpp - clv2 option registration ----------===//
//
...
// registration.  See ObjCARCOptionsRegistration.h.
//
//===----------------------------------------------------------------------===//
...
void llvm::registerObjCARCOptsOptions(llvm::clv2::OptionParser &P) {
