//===- BPF.cpp - clv2 BPF option registration -----------------===//
//
...
//===----------------------------------------------------------------------===//
//
// Registers BPF's options into RegisterAllLLVMOptions.
//
...
//
// These live in LLVMAllOptions rather than calling the registerBPFOptions()
// in lib/Target/BPF: LLVMAllOptions is linked by clang tools that do not link
