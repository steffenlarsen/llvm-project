//===- PowerPC.cpp - clv2 PowerPC option registration -----------------===//
//
...
//===----------------------------------------------------------------------===//
//
// Registers PowerPC's options into RegisterAllLLVMOptions.
//
...
//
// These live in LLVMAllOptions rather than calling the registerPowerPCOptions()
// in lib/Target/PowerPC: LLVMAllOptions is linked by clang tools that do not
