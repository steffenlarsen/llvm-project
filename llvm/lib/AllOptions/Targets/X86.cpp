//===- X86.cpp - clv2 X86 option registration -----------------===//
//
...
//===----------------------------------------------------------------------===//
//
// Registers X86's options into RegisterAllLLVMOptions.
//
...
//
// These live in LLVMAllOptions rather than calling the registerX86Options()
// in lib/Target/X86: LLVMAllOptions is linked by clang tools that do not link
