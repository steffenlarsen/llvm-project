//===- NVPTX.cpp - clv2 NVPTX option registration -----------------===//
//
...
//===----------------------------------------------------------------------===//
//
// Registers NVPTX's options into RegisterAllLLVMOptions.
//
...
//
// These live in LLVMAllOptions rather than calling the registerNVPTXOptions()
// in lib/Target/NVPTX: LLVMAllOptions is linked by clang tools that do not link
