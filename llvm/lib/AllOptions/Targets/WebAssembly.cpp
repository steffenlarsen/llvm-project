//===- WebAssembly.cpp - clv2 WebAssembly option registration
//-----------------===//
//
...
//===----------------------------------------------------------------------===//
//
// Registers WebAssembly's options into RegisterAllLLVMOptions.
//
...
// registerWebAssemblyOptions() in lib/Target/WebAssembly: LLVMAllOptions is
// linked by clang tools that do not link target CodeGen, and making them do so
// to reach a registration function would cost far more binary size than this
// saves.
//
//===----------------------------------------------------------------------===//
