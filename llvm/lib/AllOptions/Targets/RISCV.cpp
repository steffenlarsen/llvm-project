//===- RISCV.cpp - clv2 RISCV option registration -----------------===//
//
...
//===----------------------------------------------------------------------===//
//
// Registers RISCV's options into RegisterAllLLVMOptions.
//
...
//
// These live in LLVMAllOptions rather than calling the registerRISCVOptions()
// in lib/Target/RISCV: LLVMAllOptions is linked by clang tools that do not link
