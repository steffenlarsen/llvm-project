//===- XCore.cpp - clv2 XCore option registration -----------------===//
//
...
//===----------------------------------------------------------------------===//
//
// Registers XCore's options into RegisterAllLLVMOptions.
//
...
//
// These live in LLVMAllOptions rather than calling the registerXCoreOptions()
// in lib/Target/XCore: LLVMAllOptions is linked by clang tools that do not link
