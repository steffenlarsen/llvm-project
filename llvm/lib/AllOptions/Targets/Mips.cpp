//===- Mips.cpp - clv2 Mips option registration -----------------===//
//
...
//===----------------------------------------------------------------------===//
//
// Registers Mips's options into RegisterAllLLVMOptions.
//
...
//
// These live in LLVMAllOptions rather than calling the registerMipsOptions()
// in lib/Target/Mips: LLVMAllOptions is linked by clang tools that do not link
