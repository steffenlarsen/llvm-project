//===- Lanai.cpp - clv2 Lanai option registration -----------------===//
//
...
//===----------------------------------------------------------------------===//
//
// Registers Lanai's options into RegisterAllLLVMOptions.
//
...
//
// These live in LLVMAllOptions rather than calling the registerLanaiOptions()
// in lib/Target/Lanai: LLVMAllOptions is linked by clang tools that do not link
