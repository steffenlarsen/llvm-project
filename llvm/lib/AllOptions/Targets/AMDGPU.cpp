//===- AMDGPU.cpp - clv2 AMDGPU option registration -----------------===//
//
...
//===----------------------------------------------------------------------===//
//
// Registers AMDGPU's options into RegisterAllLLVMOptions.
//
...
//
// These live in LLVMAllOptions rather than calling the registerAMDGPUOptions()
// in lib/Target/AMDGPU: LLVMAllOptions is linked by clang tools that do not
