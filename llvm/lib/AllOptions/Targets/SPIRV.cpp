//===- SPIRV.cpp - clv2 SPIRV option registration -----------------===//
//
...
//===----------------------------------------------------------------------===//
//
// Registers SPIRV's options into RegisterAllLLVMOptions.
//
...
//
// These live in LLVMAllOptions rather than calling the registerSPIRVOptions()
// in lib/Target/SPIRV: LLVMAllOptions is linked by clang tools that do not link
