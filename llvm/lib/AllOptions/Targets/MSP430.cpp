//===- MSP430.cpp - clv2 MSP430 option registration -----------------===//
//
...
//===----------------------------------------------------------------------===//
//
// Registers MSP430's options into RegisterAllLLVMOptions.
//
...
//
// These live in LLVMAllOptions rather than calling the registerMSP430Options()
// in lib/Target/MSP430: LLVMAllOptions is linked by clang tools that do not
