//===- CGDataOptionsRegistration.cpp - clv2 option registration ----------===//
//
...
// registration.  See CGDataOptionsRegistration.h.
//
//===----------------------------------------------------------------------===//
...
void llvm::registerCGDataOptsOptions(llvm::clv2::OptionParser &P) {
