//===- OpenMPOptionsRegistration.cpp - clv2 option registration ----------===//
//
...
// registration.  See OpenMPOptionsRegistration.h.
//
//===----------------------------------------------------------------------===//
...
void llvm::registerOMPOptsOptions(llvm::clv2::OptionParser &P) {
  P.add<&clv2::OMPOptsReg>();
}
