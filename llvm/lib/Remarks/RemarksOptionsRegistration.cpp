//===- RemarksOptionsRegistration.cpp - clv2 option registration ----------===//
//
...
// registration.  See RemarksOptionsRegistration.h.
//
//===----------------------------------------------------------------------===//
...
void llvm::registerRemarksOptsOptions(llvm::clv2::OptionParser &P) {
