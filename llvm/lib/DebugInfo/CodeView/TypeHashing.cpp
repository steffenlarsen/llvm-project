...
const LocallyHashedType DenseMapInfo<LocallyHashedType>::Empty{0, {}};
const LocallyHashedType DenseMapInfo<LocallyHashedType>::Tombstone{
    hash_code(-1), {}};

static const std::array<uint8_t, 8> EmptyHash = {
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}};
static const std::array<uint8_t, 8> TombstoneHash = {
    {0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}};

const GloballyHashedType DenseMapInfo<GloballyHashedType>::Empty{EmptyHash};
const GloballyHashedType DenseMapInfo<GloballyHashedType>::Tombstone{
    TombstoneHash};
