...
static LLVMContext &getGlobalContext() {
  static LLVMContext GlobalContext(llvm::clv2::defaultOptionsContext());
...
LLVMContextRef LLVMContextCreate() {
  return wrap(new LLVMContext(llvm::clv2::defaultOptionsContext()));
}

LLVMContextRef LLVMContextCreateWithOptions(LLVMOptionsContextRef Opts) {
  return wrap(new LLVMContext(
      Opts ? *reinterpret_cast<const clv2::OptionsContext *>(Opts)
