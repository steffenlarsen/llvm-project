//===- ProfileDataOptionsRegistration.cpp - clv2 option registration
//----------===//
//
...
// registration.  See ProfileDataOptionsRegistration.h.
//
//===----------------------------------------------------------------------===//
...
void llvm::registerProfileDataOptsOptions(llvm::clv2::OptionParser &P) {
