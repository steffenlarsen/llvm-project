...
static constexpr clv2::OptionsRegistry<&InputIROpt, &UseObjectCacheOpt>
    KaleidoscopeReg;
...
class MCJITHelper {
public:
  MCJITHelper(LLVMContext &C, bool UseObjectCache)
      : Context(C), OpenModule(NULL), UseObjectCache(UseObjectCache) {}
  ~MCJITHelper();
...
int main(int argc, char **argv) {
  ...
  TheHelper = new MCJITHelper(Context, UseObjectCache);
