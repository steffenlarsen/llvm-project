...
static std::string InputIR;
static bool VerboseOutput = false;
static bool SuppressPrompts = false;
static bool DumpModulesOnExit = false;
static bool EnableLazyCompilation = true;
static bool UseObjectCache = false;
...
int main(int argc, char **argv) {
  ...
  InputIR = std::string(Opts->get<&InputIROpt>());
  VerboseOutput = Opts->get<&VerboseOutputOpt>();
  SuppressPrompts = Opts->get<&SuppressPromptsOpt>();
  DumpModulesOnExit = Opts->get<&DumpModulesOnExitOpt>();
  EnableLazyCompilation = Opts->get<&EnableLazyCompilationOpt>();
  UseObjectCache = Opts->get<&UseObjectCacheOpt>();
