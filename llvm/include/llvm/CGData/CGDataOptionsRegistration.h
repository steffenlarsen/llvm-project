//===- CGDataOptionsRegistration.h - clv2 option registration ---*- C++ -*-===//
//
...
#ifndef LLVM_CGDATA_CGDATAOPTIONSREGISTRATION_H
#define LLVM_CGDATA_CGDATAOPTIONSREGISTRATION_H
...
void registerCGDataOptsOptions(clv2::OptionParser &P);

} // namespace llvm

#endif // LLVM_CGDATA_CGDATAOPTIONSREGISTRATION_H
