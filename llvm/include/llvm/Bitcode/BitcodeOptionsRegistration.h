//===- BitcodeOptionsRegistration.h - clv2 option registration ---*- C++
//-*-===//
//
...
#ifndef LLVM_BITCODE_BITCODEOPTIONSREGISTRATION_H
#define LLVM_BITCODE_BITCODEOPTIONSREGISTRATION_H
...
void registerBitcodeOptsOptions(clv2::OptionParser &P);

} // namespace llvm

#endif // LLVM_BITCODE_BITCODEOPTIONSREGISTRATION_H
