...
// boolOrDefault is declared in BoolOrDefault.h, included above, so cl:: and
// clv2 name the same type.
template <>
...
//
// The tokenizers, TokenizerCallback, ExpansionContext and the response-file
// helpers are declared in CommandLineTokenizer.h, included above, so that
// cl:: and clv2 share one implementation.
//
