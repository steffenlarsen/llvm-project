//===- IROptionsRegistration.h - clv2 option registration ---*- C++ -*-===//
//
...
#ifndef LLVM_IR_IROPTIONSREGISTRATION_H
#define LLVM_IR_IROPTIONSREGISTRATION_H
...
void registerIROptsOptions(clv2::OptionParser &P);

} // namespace llvm

#endif // LLVM_IR_IROPTIONSREGISTRATION_H
