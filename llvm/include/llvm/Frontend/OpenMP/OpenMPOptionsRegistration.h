//===- OpenMPOptionsRegistration.h - clv2 option registration ---*- C++ -*-===//
//
...
#ifndef LLVM_FRONTEND_OPENMP_OPENMPOPTIONSREGISTRATION_H
#define LLVM_FRONTEND_OPENMP_OPENMPOPTIONSREGISTRATION_H
...
void registerOMPOptsOptions(clv2::OptionParser &P);

} // namespace llvm

#endif // LLVM_FRONTEND_OPENMP_OPENMPOPTIONSREGISTRATION_H
