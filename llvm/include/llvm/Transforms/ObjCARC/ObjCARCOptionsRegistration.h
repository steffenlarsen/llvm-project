//===- ObjCARCOptionsRegistration.h - clv2 option registration ---*- C++
//-*-===//
//
...
#ifndef LLVM_TRANSFORMS_OBJCARC_OBJCARCOPTIONSREGISTRATION_H
#define LLVM_TRANSFORMS_OBJCARC_OBJCARCOPTIONSREGISTRATION_H
...
void registerObjCARCOptsOptions(clv2::OptionParser &P);

} // namespace llvm

#endif // LLVM_TRANSFORMS_OBJCARC_OBJCARCOPTIONSREGISTRATION_H
