//===- VectorizeOptionsRegistration.h - clv2 option registration ---*- C++
//-*-===//
//
...
#ifndef LLVM_TRANSFORMS_VECTORIZE_VECTORIZEOPTIONSREGISTRATION_H
#define LLVM_TRANSFORMS_VECTORIZE_VECTORIZEOPTIONSREGISTRATION_H
...
void registerVectorizeOptsOptions(clv2::OptionParser &P);

} // namespace llvm

#endif // LLVM_TRANSFORMS_VECTORIZE_VECTORIZEOPTIONSREGISTRATION_H
