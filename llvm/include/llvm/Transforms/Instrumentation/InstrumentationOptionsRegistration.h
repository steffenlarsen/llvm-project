//===- InstrumentationOptionsRegistration.h - clv2 option registration ---*- C++
//-*-===//
//
...
#ifndef LLVM_TRANSFORMS_INSTRUMENTATION_INSTRUMENTATIONOPTIONSREGISTRATION_H
#define LLVM_TRANSFORMS_INSTRUMENTATION_INSTRUMENTATIONOPTIONSREGISTRATION_H
...
void registerInstrumentationOptsOptions(clv2::OptionParser &P);

} // namespace llvm

#endif // LLVM_TRANSFORMS_INSTRUMENTATION_INSTRUMENTATIONOPTIONSREGISTRATION_H
