//===- IPOOptionsRegistration.h - clv2 option registration ---*- C++ -*-===//
//
...
#ifndef LLVM_TRANSFORMS_IPO_IPOOPTIONSREGISTRATION_H
#define LLVM_TRANSFORMS_IPO_IPOOPTIONSREGISTRATION_H
...
void registerIPOOptsOptions(clv2::OptionParser &P);

} // namespace llvm

#endif // LLVM_TRANSFORMS_IPO_IPOOPTIONSREGISTRATION_H
