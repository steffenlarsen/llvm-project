//===- UtilsOptionsRegistration.h - clv2 option registration ---*- C++ -*-===//
//
...
#ifndef LLVM_TRANSFORMS_UTILS_UTILSOPTIONSREGISTRATION_H
#define LLVM_TRANSFORMS_UTILS_UTILSOPTIONSREGISTRATION_H
...
void registerTransformUtilsOptsOptions(clv2::OptionParser &P);

} // namespace llvm

#endif // LLVM_TRANSFORMS_UTILS_UTILSOPTIONSREGISTRATION_H
