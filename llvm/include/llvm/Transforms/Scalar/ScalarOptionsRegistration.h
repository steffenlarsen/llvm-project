//===- ScalarOptionsRegistration.h - clv2 option registration ---*- C++ -*-===//
//
...
#ifndef LLVM_TRANSFORMS_SCALAR_SCALAROPTIONSREGISTRATION_H
#define LLVM_TRANSFORMS_SCALAR_SCALAROPTIONSREGISTRATION_H
...
void registerScalarOptsOptions(clv2::OptionParser &P);

} // namespace llvm

#endif // LLVM_TRANSFORMS_SCALAR_SCALAROPTIONSREGISTRATION_H
