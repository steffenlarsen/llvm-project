//===- CoroutinesOptionsRegistration.h - clv2 option registration ---*- C++
//-*-===//
//
...
#ifndef LLVM_TRANSFORMS_COROUTINES_COROUTINESOPTIONSREGISTRATION_H
#define LLVM_TRANSFORMS_COROUTINES_COROUTINESOPTIONSREGISTRATION_H
...
void registerCoroutinesOptsOptions(clv2::OptionParser &P);

} // namespace llvm

#endif // LLVM_TRANSFORMS_COROUTINES_COROUTINESOPTIONSREGISTRATION_H
