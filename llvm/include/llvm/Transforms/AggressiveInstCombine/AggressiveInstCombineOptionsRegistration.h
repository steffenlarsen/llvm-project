//===- AggressiveInstCombineOptionsRegistration.h - clv2 option registration
//---*- C++ -*-===//
//
...
#ifndef LLVM_TRANSFORMS_AGGRESSIVEINSTCOMBINE_AGGRESSIVEINSTCOMBINEOPTIONSREGISTRATION_H
#define LLVM_TRANSFORMS_AGGRESSIVEINSTCOMBINE_AGGRESSIVEINSTCOMBINEOPTIONSREGISTRATION_H
...
void registerAggressiveInstCombineOptsOptions(clv2::OptionParser &P);

} // namespace llvm

#endif // LLVM_TRANSFORMS_AGGRESSIVEINSTCOMBINE_AGGRESSIVEINSTCOMBINEOPTIONSREGISTRATION_H
