//===- InstCombineOptionsRegistration.h - clv2 option registration ---*- C++
//-*-===//
//
...
#ifndef LLVM_TRANSFORMS_INSTCOMBINE_INSTCOMBINEOPTIONSREGISTRATION_H
#define LLVM_TRANSFORMS_INSTCOMBINE_INSTCOMBINEOPTIONSREGISTRATION_H
...
void registerInstCombineOptsOptions(clv2::OptionParser &P);

} // namespace llvm

#endif // LLVM_TRANSFORMS_INSTCOMBINE_INSTCOMBINEOPTIONSREGISTRATION_H
