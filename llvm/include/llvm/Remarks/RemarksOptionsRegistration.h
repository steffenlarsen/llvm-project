//===- RemarksOptionsRegistration.h - clv2 option registration ---*- C++
//-*-===//
//
...
#ifndef LLVM_REMARKS_REMARKSOPTIONSREGISTRATION_H
#define LLVM_REMARKS_REMARKSOPTIONSREGISTRATION_H
...
void registerRemarksOptsOptions(clv2::OptionParser &P);

} // namespace llvm

#endif // LLVM_REMARKS_REMARKSOPTIONSREGISTRATION_H
