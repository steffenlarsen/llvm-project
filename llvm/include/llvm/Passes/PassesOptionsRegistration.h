//===- PassesOptionsRegistration.h - clv2 option registration ---*- C++ -*-===//
//
...
#ifndef LLVM_PASSES_PASSESOPTIONSREGISTRATION_H
#define LLVM_PASSES_PASSESOPTIONSREGISTRATION_H
...
void registerPassesOptsOptions(clv2::OptionParser &P);

} // namespace llvm

#endif // LLVM_PASSES_PASSESOPTIONSREGISTRATION_H
