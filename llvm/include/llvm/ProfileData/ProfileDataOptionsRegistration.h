//===- ProfileDataOptionsRegistration.h - clv2 option registration ---*- C++
//-*-===//
//
...
#ifndef LLVM_PROFILEDATA_PROFILEDATAOPTIONSREGISTRATION_H
#define LLVM_PROFILEDATA_PROFILEDATAOPTIONSREGISTRATION_H
...
void registerProfileDataOptsOptions(clv2::OptionParser &P);

} // namespace llvm

#endif // LLVM_PROFILEDATA_PROFILEDATAOPTIONSREGISTRATION_H
