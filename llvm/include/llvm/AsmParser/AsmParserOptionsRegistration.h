//===- AsmParserOptionsRegistration.h - clv2 option registration ---*- C++
//-*-===//
//
...
#ifndef LLVM_ASMPARSER_ASMPARSEROPTIONSREGISTRATION_H
#define LLVM_ASMPARSER_ASMPARSEROPTIONSREGISTRATION_H
...
void registerAsmParserOptsOptions(clv2::OptionParser &P);

} // namespace llvm

#endif // LLVM_ASMPARSER_ASMPARSEROPTIONSREGISTRATION_H
