//===- AnalysisOptionsRegistration.h - clv2 option registration ---*- C++
//-*-===//
//
...
#ifndef LLVM_ANALYSIS_ANALYSISOPTIONSREGISTRATION_H
#define LLVM_ANALYSIS_ANALYSISOPTIONSREGISTRATION_H
...
void registerAnalysisOptsOptions(clv2::OptionParser &P);

} // namespace llvm

#endif // LLVM_ANALYSIS_ANALYSISOPTIONSREGISTRATION_H
