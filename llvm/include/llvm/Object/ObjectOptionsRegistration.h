//===- ObjectOptionsRegistration.h - clv2 option registration ---*- C++ -*-===//
//
...
#ifndef LLVM_OBJECT_OBJECTOPTIONSREGISTRATION_H
#define LLVM_OBJECT_OBJECTOPTIONSREGISTRATION_H
...
void registerObjectOptsOptions(clv2::OptionParser &P);

} // namespace llvm

#endif // LLVM_OBJECT_OBJECTOPTIONSREGISTRATION_H
