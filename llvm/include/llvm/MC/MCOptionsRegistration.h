//===- MCOptionsRegistration.h - clv2 option registration ---*- C++ -*-===//
//
...
#ifndef LLVM_MC_MCOPTIONSREGISTRATION_H
#define LLVM_MC_MCOPTIONSREGISTRATION_H
...
void registerMCOptsOptions(clv2::OptionParser &P);

} // namespace llvm

#endif // LLVM_MC_MCOPTIONSREGISTRATION_H
