...
static constexpr OptionCategory Yaml2ObjCat{"yaml2obj Options"};

static constexpr OptionInfo<std::string> Input{
    "input", "<input file>", Positional{}, Init{"-"}, Cat(Yaml2ObjCat)};
...
static constexpr ListOptionInfo<std::string> D{
    ...
    PrefixFormat, Cat(Yaml2ObjCat)};

static constexpr OptionInfo<bool> PreprocessOnly{
    "E", "Just print the preprocessed file", Cat(Yaml2ObjCat)};
