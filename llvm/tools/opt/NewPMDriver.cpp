...
static void registerEPCallbacks(PassBuilder &PB, const NPMOptions &NPMOpts) {
  ...
  if (tryParsePipelineText<ModulePassManager>(
          PB, "passes-ep-thin-link-time-optimization-early",
          NPMOpts.ThinLinkTimeOptimizationEarlyEPPipeline)) {
    std::string Pipeline = NPMOpts.ThinLinkTimeOptimizationEarlyEPPipeline;
  ...
  if (tryParsePipelineText<ModulePassManager>(
          PB, "passes-ep-thin-link-time-optimization-last",
          NPMOpts.ThinLinkTimeOptimizationLastEPPipeline)) {
    std::string Pipeline = NPMOpts.ThinLinkTimeOptimizationLastEPPipeline;
