...
inline constexpr OptionInfo<std::string> NPM_ThinLTOEarlyEP{
    "passes-ep-thin-link-time-optimization-early",
    "A textual description of the module pass pipeline inserted at "
    "the ThinLinkTimeOptimizationEarly extension point into default pipelines",
    Hidden};

inline constexpr OptionInfo<std::string> NPM_ThinLTOLastEP{
    "passes-ep-thin-link-time-optimization-last",
    "A textual description of the module pass pipeline inserted at "
    "the ThinLinkTimeOptimizationLast extension point into default pipelines",
    Hidden};
...
inline constexpr OptionsRegistry<
    ...
    &NPM_ThinLTOEarlyEP, &NPM_ThinLTOLastEP, &NPM_DisablePipelineVerification,
    &NPM_PGOKind, &NPM_ProfileFile, &NPM_MemoryProfileFile, &NPM_CSPGOKind,
    &NPM_CSProfileGenFile, &NPM_ProfileRemappingFile, &NPM_PGOColdFuncAttr,
    &NPM_DebugInfoForProfiling, &NPM_PseudoProbeForProfiling,
    &NPM_DisableLoopUnrolling,
...
optMain(int argc, char **argv,
  ...
  NPMOpts.ThinLinkTimeOptimizationEarlyEPPipeline =
      Opts->get<&NPM_ThinLTOEarlyEP>();
  NPMOpts.ThinLinkTimeOptimizationLastEPPipeline =
      Opts->get<&NPM_ThinLTOLastEP>();
