...
static constexpr OptionCategory VerifyUselistorderCat{
...
static void verifyUseListOrder(Module &M, const clv2::OptionsContext &OptsCtx,
                               bool SaveTemps) {
  outs() << "verify bitcode\n";
...
int main(int argc, char **argv) {
  ...
  P.hideUnrelatedOptions({&VerifyUselistorderCat});
