...
static std::string ProgramToRun;
static std::vector<std::string> Argv;
static bool TraceExecution;
static unsigned Timeout;
static bool NoUser32;
...
int main(int argc, char **argv) {
  ...
  ProgramToRun = Opts->get<&ProgramToRunOpt>();
  Argv = Opts->get<&ArgvOpt>();
  TraceExecution = Opts->get<&TraceExecutionOpt>();
  Timeout = Opts->get<&TimeoutOpt>();
  NoUser32 = Opts->get<&NoUser32Opt>();
