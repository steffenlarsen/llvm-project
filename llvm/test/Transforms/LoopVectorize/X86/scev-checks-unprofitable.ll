...
; CHECK-NEXT:    [[IV_4:%.*]] = phi i64 [ [[IV_4_NEXT:%.*]], %[[EXIT_1_LOOPEXIT1]] ], [ 0, %[[LOOP_3_PREHEADER]] ]
...
; CHECK-NEXT:    br i1 [[EC_3]], label %[[EXIT_1_LOOPEXIT1]], label %[[EXIT_1_LOOPEXIT2:.*]]
; CHECK:       [[EXIT_1_LOOPEXIT]]:
; CHECK-NEXT:    br label %[[EXIT_1:.*]]
; CHECK:       [[EXIT_1_LOOPEXIT2]]:
; CHECK-NEXT:    br label %[[EXIT_1]]
; CHECK:       [[EXIT_1]]:
; CHECK-NEXT:    ret void
;
