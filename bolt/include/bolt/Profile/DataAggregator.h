...
private:
  ...
  /// parsing.
  Error launchPerfProcess(StringRef Name, PerfProcessInfo &PPI, StringRef Args);
  ...
  /// Parse the full output generated by perf script to report main samples.
  std::error_code parseMainEvents();
