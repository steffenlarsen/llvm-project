...
inline constexpr OptionInfo<bool> BBC_FpSumReassociation{
...
inline constexpr OptionsRegistry<
    ...
    &BBC_FpSumReassociation, &BBC_StackRepackArrays, &BBC_RepackArrays,
    &BBC_RepackArraysWhole, &BBC_ComplexRange, &BBC_FPMaxminBehavior>
    BBCToolReg;
...
static llvm::LogicalResult convertFortranSourceToMLIR(
  ...
  bool fpSumReassociation = Opts->get<&BBC_FpSumReassociation>();
